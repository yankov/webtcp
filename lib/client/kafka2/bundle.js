...
//  *
 //        buf = new Buffer(buf, "utf-8")
	...
	// this._processData = function (buf) {
        ...
        // test message
        // test channel
        // <Buffer 00 00 00 17 00 00 00 00 00 11 00 1f 8c 67 8b 74 65 73 74 20 6d 65 73 73 61 67 65>
        // privet
        // <Buffer 00 00 00 0b 00 60 42 99 61 70 72 69 76 65 74>

        // buf = [0x00, 0x00, 0x00, 0x17, 0x00, 0x00, 0x00, 0x00, 0x00, 0x11, 0x00, 0x1f, 0x8c, 67, 0x8b, 0x74, 0x65, 0x73, 0x74, 0x20, 0x6d,  0x65, 0x73, 0x73, 0x61, 0x67, 0x65]
        // buf = new Buffer("test", "utf-8")
    
        
        buf = [0x00, 0x00, 0x00, 0x17, 0x00, 0x00, 0x00, 0x00, 0x00, 0x11, 0x00, 0x1f, 0x8c, 67, 0x8b, 0x74, 0x65, 0x73, 0x74, 0x20, 0x6d,  0x65, 0x73, 0x73, 0x61, 0x67, 0x65]
        // buf = this._bufferPacket(std.pack('N', buf.length) + buf.join(""))
