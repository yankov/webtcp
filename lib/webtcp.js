var WebTCP = function(host, port) {
   ...
   this.outputBuffer = [];
     ...
     this.createSocket = function() {
       socket = new this.Socket.apply(arguments);
       socket.webtcp = this;
     }

     this.createHTTPClient = function() {
       return new this.Http(this);
     };
}

// HTTP client
WebTCP.prototype.Http = function(webtcp) {
...
// Socket client
WebTCP.prototype.Socket = function(webtcp, host, port, options) {
